      ...
      <ul class="custom-scrollbar">
        ...
        <li>
          <ul class="collapsible collapsible-accordion">
            ...
            <li>
              ...
              <div class="collapsible-body">
                <ul>
                  ...
                  <li>
                    <a href="../employee/employee_account.php" class="waves-effect">Account</a>
                  </li>
                </ul>
              </div>
            </li>
            <li>
              <a class="collapsible-header waves-effect arrow-r">
              <i class="fab fa-wpforms"></i>Employee Leaves<i class="fas fa-angle-down rotate-icon"></i>
              </a>
              <div class="collapsible-body">
                <ul>
                  <li>
                    <a href="../employee_leave/employee_leave.php" class="waves-effect">Requested Leave</a>
                  </li>
                  <li>
                    <a href="../employee_leave/employee_leave_history.php" class="waves-effect">History</a>
                  </li>
                </ul>
              </div>
            </li>
            <li>
              <a class="collapsible-header waves-effect arrow-r">
              <i class="fas fa-landmark"></i>Department<i class="fas fa-angle-down rotate-icon"></i>
              </a>
              <div class="collapsible-body">
                <ul>
                  <li>
                    <a href="../employee/department.php" class="waves-effect">List</a>
                  </li>
                  <li>
            ...
            <li>
              <a class="collapsible-header waves-effect arrow-r">
                <i class="fas fa-history"></i>History<i class="fas fa-angle-down rotate-icon"></i>
              </a>
              <div class="collapsible-body">
                <ul>
                  <li>
                    <a href="../employee/history_resign.php" class="waves-effect">Resign</a>
                  </li>
                  <li>
                    <a href="../employee/history_renew.php" class="waves-effect">Renew</a>
                  </li>
                  <li>
                    <a href="../employee/history_promoted.php" class="waves-effect">Promote</a>
                  </li>
                  <li>
                    <!-- <a href="../css/media.html" class="waves-effect">Media object</a> -->
                  </li>
      ...
      <div class="d-flex change-mode">
        ...
        <ul class="nav navbar-nav nav-flex-icons ml-auto">
          ...
          <li class="nav-item dropdown">
            ...
            <a class="dropdown-item" href="../profile/hr_PDS.php">
            <i class="fas fa-file-pdf"></i>
                My PDS
            </a>
            <a class="dropdown-item" href="../profile/hr_profile.php">
            <i class="fas fa-id-card"></i>
                Profile
            </a>
          
            <a href='../leave/leave_request.php' class="dropdown-item"> 
            <i class="fas fa-pen-square"></i> 
            Leave Request</a>
            <a href='../leave/leave_status.php' class="dropdown-item">
            <i class="fas fa-chart-line"></i> 
            Leave Status</a>
            <a href='../leave/leave_history.php' class="dropdown-item">
            <i class="fas fa-book"></i> 
            Leave History</a>
            <a href='../leave/leave_indexcard.php' class='waves-effect'>
