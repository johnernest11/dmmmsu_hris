              ...
              <div class="card-body card-body-cascade ">
                ...
                <img width="200" height="150" src="<?php echo $pending_picture;?>" class="float-right"  alt="Responsive-image" >
                    ...
                    <br>
                                <br>
                                <br>
                                <h6 class="text-center">asdasdsa</h6>
                    ...
                    <br>
                                ...
                                <img id='recieve' width="220" height="140" src="../../../PICTURE/RECEIVED.png"  alt="Responsive-image" >
                     <p id="date_recieved"  for="checkbox5" "><?php echo$date_received; ?></p>
                            
                            <input type="hidden" class="form-control" id="validationDesfault03" name="leave_reco_head" value="Pending" required>
                    </div>
