                ...
                <img width="200" height="150" src="<?php echo $pending_picture;?>" class="float-right"  alt="Responsive-image" >
                    ...
                    <br>
                            ...
                            <div class="row">
                                ...
                                <input type="date" class="form-control border-0 " id="validationDefault03" name="leave_from" value="<?php echo$leave_from;?>"  >
                                </div>
                                <div class="col-md-6 ">
                                <label for="validationDefault03" class="form-label">DATE TO:</label>
                                <input type="date" class="form-control border-0 " id="validationDefault03" name="leave_to" value="<?php echo$leave_to;?>" >
                                </div>
                               </div>
                    </div>
                            <div class="col-md-6">
                            ...
                            <fieldset class="form-check ml-4">
                                ...
                                <div class="md-form ml-5">
                                        ...
                                        <input type="text" id="form3" name="leave_spent2" class="form-control" value="<?php echo$leave_spent2;?>" disabled>
                                </div>
                                <fieldset class="form-check ml-4">
                    ...
                    <br>
                            ...
                            <label for="validationDefault03" class="form-label">RECOMMENDATION</label>
                                <fieldset class="form-check ml-4">
                                <input class="form-check-input" type="checkbox" id="checkboxa" name="leave_recommendation[]" value="Approved" <?php echo$leave_recommendation =='Approved' ? 'checked' : '';?> disabled>
                                <label class="form-check-label" for="checkboxa">Approved</label>
                                </fieldset>
                                <div class="md-form ml-5">
                                        <label class="active" for="checkbox6">Disapproved due to</label>
                                        <input type="text" id="form1" class="form-control" name="leave_recommendation_due" value="<?php echo$leave_recommendation_due;?>" >
                                </div>
                                <br> 
                                <h5 class="text-center"><b><u><?php  
                                  ...
                                  $account9 = $conn->prepare("SELECT * FROM emp_profile INNER JOIN account ON account.Id = emp_profile.account_id 
                                   WHERE account.role='Dean' AND account.employee_department = '$employee_department'");
                                  $account9->execute(); 
                                  while($result9 = $account9->fetch(PDO::FETCH_ASSOC)):;
                    ...
                    <fieldset class="form-check">
                                <input class="form-check-input" type="checkbox" id="checkbox5aab" name="leave_status[]" value="Approved" >
                                <label class="form-check-label" for="checkbox5aab">APPROVED FOR:</label>
                    </fieldset>
                    <fieldset class="form-check ml-4">
                                <input class="form-check-input" type="checkbox" id="checkbox5aa" name="leave_status_due[]" value="Days with pay" >
                                <label class="form-check-label" for="checkbox5aa">Days with pay</label>
                    </fieldset>
                    <fieldset class="form-check ml-4">
                                <input class="form-check-input" type="checkbox" id="checkbox5bb" name="leave_status_due[]" value="Days without pay" >
                                <label class="form-check-label" for="checkbox5bb">Days without pay</label>
                    </fieldset>
                    <div class="md-form ml-5">
                            <label class="active" for="checkbox6">Other (Specify)</label>
                            <input type="text" id="form1" name="leave_status_due[]" class="form-control" >
                    </div>       
                    </div>
                            <div class="col-md-6">
                            <fieldset class="form-check">
                                <input class="form-check-input" type="checkbox" id="checkbox5aann" name="leave_status[]" value="Not Approved" >
                                <label class="form-check-label" for="checkbox5aann">DISAPPROVED DUE TO:</label>
                             </fieldset>
                            
                                <div class="md-form ml-5">
                                <label class="active" for="checkbox6">Disapproved due to:</label>
                                        <input type="text" name="leave_status_due[]" id="form1" class="form-control" >
                                </div> 
                            </div>
                    ...
                    <div class="col-lg-6 col-md-6 mb-6">
                    <input type="hidden" id="form1" class="form-control" name="cre_vbalance" value="<?php echo$cre_vbalance;?>">
                    <input type="hidden" id="form1" class="form-control" name="cre_sbalance" value="<?php echo$cre_sbalance;?>">
                    ...
                    <hr style="height:2px;border-width:0;color:gray;background-color:gray">
                            <div class="col-12">
                                <button class="btn btn-primary" type="submit"name="Comfirmleave" ><i class='fas fa-sign-in-alt'></i> Update Request</button>
                            </div>
                    </div>
                </form>
            </div>
