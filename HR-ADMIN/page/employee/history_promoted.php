...
<!-- Page Heading -->
<br>
<h1 class="h3 mb-2 text-gray-800">LIST OF PROMOTED EMPLOYEES</h1>
<br>
<hr>
        <br>
            <br>
...
<div class="card shadow mb-4 ">
    <div class="card-header py-3 btn peach-primary btn-rounded">
        <h6 class="m-0 font-weight-bold text-primary">Promoted Employees</h6>
    </div>
    <div class="card-body">
        ...
        <table id="myTable" class="table table-striped employee" cellspacing="0" width="100%">
                ...
                <?php
                    ...
                    WHERE emp_history.work_history ='Promote'");
                    $account->execute();
                    while($result = $account->fetch(PDO::FETCH_ASSOC)){
                      echo '<tr>
                              ...
                              <td>'.$result["employee_position"].'</td>
                               ...
                               <td style="color:blue"><strong>'.$result["work_history"].'</strong></td>
