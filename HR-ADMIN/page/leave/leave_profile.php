              ...
              <div class="card-body card-body-cascade ">
                ...
                <img width="200" height="150" src="<?php echo $pending_picture;?>" class="float-right"  alt="Responsive-image" >
                    ...
                    <br>
                            ...
                            <input class="form-check-input" type="checkbox" id="checkbox1" name="leave_type[]" value="Vacation" <?php echo$leave_type =='Vacation' ? 'checked' : '';?>  >
                            <label class="form-check-label" for="checkbox1">Vacation</label>
                            </fieldset>
                            <br>  
                                    <fieldset class="form-check ml-4">
                                    <input class="form-check-input" type="checkbox" id="checkbox2"  name="leave_reason" value="To seek employment" <?php echo$leave_reason =='To seek employment' ? 'checked' : '';?>>
                                    ...
                                    <div class="md-form ml-5">
                                        ...
                                        <input type="text" id="form1"  name="leave_reason1" class="form-control" value="<?php echo$leave_reason1;?>" >
                                    </div>
                                    
                            <fieldset class="form-check">
                            <input class="form-check-input" type="checkbox" id="checkbox5"name="leave_type[]" value="Sick" <?php echo$leave_type =='Sick' ? 'checked' : '';?>>
                            <label class="form-check-label" for="checkbox5">Sick</label>
                            </fieldset>
                            <fieldset class="form-check">
                            <input class="form-check-input" type="checkbox" id="checkbox6" name="leave_type[]" value="Maternity" <?php echo$leave_type =='Maternity' ? 'checked' : '';?>>
                            <label class="form-check-label" for="checkbox6">Maternity</label>
                            </fieldset>
                            <fieldset class="form-check">
                            <input class="form-check-input" type="checkbox" id="checkbox61" name="leave_type[]" value="Other" <?php echo$leave_type =='Other' ? 'checked' : '';?>>
                            <label class="form-check-label" for="checkbox61">Other</label>
                            </fieldset>
                            <div class="md-form ml-5">
                                        <label class="active">Other (Specify)</label>
                                        <input type="text" id="form1"  name="leave_reason2" class="form-control" value="<?php echo$leave_reason2;?>">
                            </div>
                            <br>
                            <div class="row">
                                <div class="col-md-12 ">
                                <label for="validationDefault03" class="form-label">NUMBER OF WORKING DAYS APPLIED FOR:</label>
                                <input type="number" class="form-control border-top-0" id="validationDefault03" name="leave_days" value="<?php echo$leave_days;?>">
                                </div>
                                <hr style="height:2px;border-width:0;color:gray;background-color:gray">
                                <div class="col-md-6 ">
                            ...
                            <label for="validationDefault03" class="form-label">IN CASE OF VACATION LEAVE</label>
                                <fieldset class="form-check ml-4">
                                <input class="form-check-input" type="checkbox" id="checkbox7" name="leave_spent[]" value="Within the Philippines" <?php echo$leave_spent =='Within the Philippines' ? 'checked' : '';?>>
                                <label class="form-check-label" for="checkbox7">Within the Philippines</label>
                                </fieldset>
                                <fieldset class="form-check ml-4">
                                    <input class="form-check-input" type="checkbox" id="checkbox151"  name="leave_spent[]" value="Abroad" <?php echo$leave_spent =='Abroad' ? 'checked' : '';?>>
                                    <label class="form-check-label" for="checkbox151">Abroad</label>
                                    </fieldset>
                                <div class="md-form ml-5">
                                        <label class="active">Abroad (Specify)</label>
                                        <input type="text" id="form1" name="leave_spent1" class="form-control" value="<?php echo$leave_spent1;?>">
                                </div>
                                
                            <label for="validationDefault03" class="form-label">IN CASE OF SICK LEAVE</label>
                            <fieldset class="form-check ml-4">
                                    <input class="form-check-input" type="checkbox" id="checkbox152"  name="leave_spent[]" value="Hospital" <?php echo$leave_spent =='Hospital' ? 'checked' : '';?>>
                                ...
                                <fieldset class="form-check ml-4">
                                    <input class="form-check-input" type="checkbox" id="checkbox153"  name="leave_spent[]" value="Out Patient" <?php echo$leave_spent =='Out Patient' ? 'checked' : '';?>>
                                    <label class="form-check-label" for="checkbox153">Out Patient</label>
                                    </fieldset>
                                <div class="md-form ml-5">
                                        <label class="active">Out Patient (Specify)</label>
                                        <input type="text" id="form2" name="leave_spent3" class="form-control" value="<?php echo$leave_spent3;?>">
                                </div>
                                <label for="validationDefault03" class="form-label">COMMUTATION</label>
                                <div class="row">
                                <div class="col-md-6">
                                <fieldset class="form-check ml-4">
                                <input class="form-check-input" type="checkbox" id="checkbox8" name="leave_commutation[]" value="Requested" <?php echo$leave_commutation =='Requested' ? 'checked' : '';?>>
                                <label class="form-check-label" for="checkbox8">Requested</label>
                                </fieldset>
                                </div>
                                <div class="col-md-6">
                                <fieldset>
                                <input class="form-check-input" type="checkbox" id="checkbox9" name="leave_commutation[]" value="Not Requested" <?php echo$leave_commutation =='Not Requested' ? 'checked' : '';?>>
