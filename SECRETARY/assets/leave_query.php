...
if (isset($_GET['edit'])){
    ...
    INNER JOIN (SELECT account_id,cre_vbalance,cre_sbalance,MAX(cre_id) AS cre_id FROM emp_credit GROUP BY cre_id) AS dt 
    ON dt.account_id =emp.account_id
