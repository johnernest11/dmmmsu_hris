...
if (isset($_GET['edit'])){
    ...
    $gad_honor =$result['gad_honor'];
     //GRADUATE STUDIES
     $gad_name1 =$result['gad_name1'];
     $gad_degree1 =$result['gad_degree1'];
     $gad_from1 =$result['gad_from1'];
     $gad_to1 =$result['gad_to1'];
     $gad_earned1=$result['gad_earned1'];
     $gad_honor1 =$result['gad_honor1'];
