...
<!-- Page Heading -->
<br>
<h1 class="h3 mb-2 text-gray-800"><i class=" fas fa-user-graduate" aria-hidden="true"></i> LIST OF EMPLOYEES WITH MASTERAL DEGREE</h1>
<br>
<hr>
    ...
    <div class="card-body">
        ...
        <table id="myTable" class="table table-striped employee" cellspacing="0" width="100%">
                ...
                <?php
                    ...
                    AND account.employee_department = '$Departmentt' AND emp_education.gad_name !='' ");
                    $account->execute();
