                ...
                <?php
                    ...
                    while($result = $account->fetch(PDO::FETCH_ASSOC)){
                      ...
                      echo '<tr>
                              ...
                              <button type="button" onclick="editDepartmente('.$department.');" class="btn btn-warning btn-sm"><span class ="fa fa-edit">Update</span></button>
                              </td>
...
<!-- End of Page Wrapper -->
<script src="js/dashboard/department.js"></script>
<script>
