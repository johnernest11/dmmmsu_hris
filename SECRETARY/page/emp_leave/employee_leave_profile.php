              ...
              <div class="card-body card-body-cascade ">
                ...
                <img width="200" height="150" src="<?php echo $pending_picture;?>" class="float-right"  alt="Responsive-image" >
                    ...
                    <br>
                            ...
                            <div class="col-md-6">
                            <fieldset>
                                <input class="form-check-input" type="checkbox" id="checkboxass" disabled >
                                <label class="form-check-label" for="checkboxass">RECOMMENDATION</label>
                               </fieldset>
                                <fieldset required class="form-check ml-4">
                               ...
                               <br>
                                <input class="form-check-input" type="checkbox" id="checkboxab" name="leave_recommendation[]" value="Disapproved" <?php echo$leave_recommendation =='Disapproved' ? 'checked' : '';?> disabled >
                                <label class="form-check-label" for="checkboxab">Disapproved</label>
                                </fieldset>
                                <div class="md-form ml-5">
                                        <label class="active" for="checkbox6">Disapproved due to</label>
                                        <input type="text" id="form1" class="form-control" name="leave_recommendation_due" value="<?php echo$leave_recommendation_due;?>"  disabled>
                                </div> 
                                <br>
                                <br>
                                <br>
                    ...
                    <hr style="height:2px;border-width:0;color:gray;background-color:gray">
                            <div class="col-12">
                                <button class="btn btn-primary" type="submit"name="UpdateLeave" ><i class='fas fa-sign-in-alt'></i> Update Request</button>
                            </div>
                    </div> -->
                </form>
            </div>
