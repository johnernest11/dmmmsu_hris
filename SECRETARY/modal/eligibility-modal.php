          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form method="POST" class="needs-validation"  novalidate >
                                    ...
                                    <div class="col-md-1 mb-2">
                                        <label for="validationCustom02">Rating</label>
                                        <input type="text" class="form-control" id="eligibility_ratinge"name="eligibility_ratinge" >
                                    </div>
                                    <div class="col-md-2 mb-2">
                                        <label for="validationCustom02">Date(mm/dd/yyyy)</label>
                                        <input type="text" class="form-control" id="eligibility_datee" name="eligibility_datee">
                                    </div>
                                    <div class="col-md-2 mb-3">
                                        <label for="validationCustom01"> Place of Examination</label>
                                    ...
                                    <div class="col-md-2 mb-2">
                                        <label for="validationCustom02">Date of Validity(mm/dd/yyyy)</label>
                                        <input type="text" class="form-control" id="eligibility_validitye" name="eligibility_validitye">
                                    </div>
                                </div>
                                <div class="modal-footer">
