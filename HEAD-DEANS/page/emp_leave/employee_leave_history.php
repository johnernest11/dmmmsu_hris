       ...
       <div class="card-body">
           ...
           <table class="table table-striped  leaveSta1 " id="dataTable" width="100%" cellspacing="0">
                ...
                <?php
                    ...
                    ON  l.account_id = account.Id  INNER JOIN emp_profile AS p  ON account.Id = p.account_id 
       ...
       <div class="card-body">
           ...
           <table class="table table-striped  leaveSta1 " id="dataTable" width="100%" cellspacing="0">
                ...
                <?php
                    ...
                    ON  l.account_id = account.Id INNER JOIN emp_profile AS p  ON account.Id = p.account_id 
                    WHERE l.leave_recommendation='Not approved' OR l.leave_status='Not approved'
                    AND account.employee_department='$_SESSION[employee_department]'");
                    $accounta->execute();
