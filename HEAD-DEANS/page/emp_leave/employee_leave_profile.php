              ...
              <div class="card-body card-body-cascade ">
                ...
                <img width="200" height="150" src="<?php echo $pending_picture;?>" class="float-right"  alt="Responsive-image" >
                    ...
                    <br>
                            ...
                            <div class="col-md-6">
                            <fieldset>
                                <input class="form-check-input" type="checkbox" id="checkboxass" required >
                                <label class="form-check-label" for="checkboxass">RECOMMENDATION</label>
                               </fieldset>
                                <fieldset required class="form-check ml-4">
                                <input class="form-check-input" type="checkbox" id="checkboxa" name="leave_recommendation[]" value="Approved" <?php echo$leave_recommendation =='Approved' ? 'checked' : '';?> >
                                <label class="form-check-label" for="checkboxa">Approved</label>
                               <br>
                                <input class="form-check-input" type="checkbox" id="checkboxab" name="leave_recommendation[]" value="Disapproved" <?php echo$leave_recommendation =='Disapproved' ? 'checked' : '';?> >
