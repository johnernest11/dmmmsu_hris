              ...
              <div class="card-body card-body-cascade ">
                ...
                <img width="200" height="150" src="<?php echo $pending_picture;?>" class="float-right"  alt="Responsive-image" >
                    ...
                    <div class="md-form ml-5">
                            ...
                            <input type="text" id="form1" name="leave_status_due[]" class="form-control" value="<?php echo$leave_status_due;?>" disabled>
                    </div>       
                    </div>
                            ...
                            <label for="validationDefault03" class="form-label">DISAPPROVED DUE TO:</label>
                                <div class="md-form ml-5">
                                        <input type="text" id="form1" class="form-control" value="<?php echo$leave_disapproved_due;?>" disabled>
                                </div> 
                            </div>
