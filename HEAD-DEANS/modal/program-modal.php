            ...
            <div class="modal-body">
                ...
                <div class="form-row">
                                    ...
                                    <div class="col-md-2 mb-2">
                                        ...
                                        <input type="text" class="form-control" id="attend_fromc"  name="attend_fromc" data-inputmask-alias="datetime" data-inputmask-inputformat="mm/dd/yyyy">
                                    </div>
                                    <div class="col-md-2 mb-3">
                                        <label for="validationCustom01">To (mm/dd/yyyy)</label>
                                        <input type="text" class="form-control" id="attend_toc"  name="attend_toc" data-inputmask-alias="datetime" data-inputmask-inputformat="mm/dd/yyyy" >
                                    </div>
                                    <div class="col-md-2 mb-2">
                                        <label for="validationCustom02">No. of Hours</label>
                                        <input type="number" class="form-control" id="attend_hoursc"  name="attend_hoursc"  >
                                    </div>
                                    <div class="col-md-2 mb-2">
                                        <label for="validationCustom02">TYPE OF LD </label>
