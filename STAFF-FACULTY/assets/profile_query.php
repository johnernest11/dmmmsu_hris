...
if (isset($_POST['Update'])) {
    ...
    $profile_query = $conn->prepare("UPDATE emp_profile SET profile_id ='$profile_id', employee_firstname = '$employee_firstname',
...
if (isset($_POST['updateEducation'])) {
    ...
    $gad_honor =$_POST['gad_honor'];
     ...
     //GRADUATE STUDIES
     $gad_name1 =$_POST['gad_name1'];
     $gad_degree1 =$_POST['gad_degree1'];
     $gad_from1 =$_POST['gad_from1'];
     $gad_to1 =$_POST['gad_to1'];
     $gad_earned1=$_POST['gad_earned1'];
     $gad_honor1 =$_POST['gad_honor1'];
    ...
    gad_name1='$gad_name1',gad_degree1 = '$gad_degree1',gad_from1='$gad_from1',gad_to1 = '$gad_to1',
    gad_earned1='$gad_earned1',gad_honor1 = '$gad_honor1'
...
if(isset($_GET['delete'])){
	$ID = $_GET['delete'];
	$mysqli->query("DELETE FROM detainee WHERE detainee_id=$detainee_id") or die ($mysqli->error());

		$_SESSION['message'] ="Record has been Deleted";
		$_SESSION['msg_type'] ="alert alert-danger";

		header("Location:view_detainee.php");
}
