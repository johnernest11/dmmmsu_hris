                ...
                <hr style="height:2px;border-width:0;color:gray;background-color:gray">
                  ...
                  <center> <p> <b>Republic of the Philippines</b></p>
                    ...
                    <div class="form-row">
                             ...
                             <input type="text"  class="form-control" id="validationCustom01" name="account_id" value="<?php echo$leave_id;?>" >
                    ...
                    <br>
                            ...
                            <input class="form-check-input" type="checkbox" id="Vacation" name="leave_type[]" value="Vacation Leave" <?php echo$leave_type =='Vacation Leave' ? 'checked' : '';?> >
                            ...
                            <fieldset class="form-check">
                            <input class="form-check-input" type="checkbox" id="Mandatory" name="leave_type[]" value="Mandatory/Forced Leave" <?php echo$leave_type =='Mandatory/Forced Leave' ? 'checked' : '';?> >
                            <label class="form-check-label" for="Mandatory"><b>Mandatory/Forced Leave</b> <small>(Sec. 25, Rule XVI, Omnibus Rules Implementing E.O No. 292)</small></label>
                             ...
                             <fieldset class="form-check">
                            <input class="form-check-input" type="checkbox" id="Sick" name="leave_type[]" value="Sick Leave" <?php echo$leave_type =='Sick Leave' ? 'checked' : '';?>>
                            ...
                            <fieldset class="form-check">
                            <input class="form-check-input" type="checkbox" id="Maternity" name="leave_type[]" value="Maternity Leave" <?php echo$leave_type =='Maternity Leave' ? 'checked' : '';?>>
                            ...
                            <fieldset class="form-check">
                            <input class="form-check-input" type="checkbox" id="Paternity" name="leave_type[]" value="Paternity Leave" <?php echo$leave_type =='Paternity Leave' ? 'checked' : '';?>>
                            ...
                            <fieldset class="form-check">
                            <input class="form-check-input" type="checkbox" id="Special" name="leave_type[]" value="Special Privilege Leave" <?php echo$leave_type =='Special Privilege Leave' ? 'checked' : '';?>>
                            ...
                            <fieldset class="form-check">
                            <input class="form-check-input" type="checkbox" id="Solo" name="leave_type[]" value="Solo Parent Leave" <?php echo$leave_type =='Solo Parent Leave' ? 'checked' : '';?>>
                            <label class="form-check-label" for="Solo"><b>Solo Parent Leave</b> <small>(RA No. 8972 / CSC MC No. 8, s. 2004)</small></label>
                            </fieldset>
                            <fieldset class="form-check">
                            <input class="form-check-input" type="checkbox" id="Study" name="leave_type[]" value="Study Leave" <?php echo$leave_type =='Study Leave' ? 'checked' : '';?>>
                            ...
                            <fieldset class="form-check">
                            <input class="form-check-input" type="checkbox" id="VAWC" name="leave_type[]" value="10-Day VAWC Leave" <?php echo$leave_type =='10-Day VAWC Leave' ? 'checked' : '';?>>
                            <label class="form-check-label" for="VAWC"><b>10-Day VAWC Leave</b> <small>(RA No. 9262 / CSC MC No. 15, s. 2005)</small></label>
                            </fieldset>
                            <fieldset class="form-check">
                            <input class="form-check-input" type="checkbox" id="Rehabilitation" name="leave_type[]" value="Rehabilitation Leave" <?php echo$leave_type =='Rehabilitation Leave' ? 'checked' : '';?>>
                            ...
                            <fieldset class="form-check">
                            <input class="form-check-input" type="checkbox" id="Benifits" name="leave_type[]" value="Special Leave Benifits for Women" <?php echo$leave_type =='Special Leave Benifits for Women' ? 'checked' : '';?>>
                            ...
                            <fieldset class="form-check">
                            <input class="form-check-input" type="checkbox" id="Emergency" name="leave_type[]" value="Special Emergency (Camality) Leave" <?php echo$leave_type =='Special Emergency (Camality) Leave' ? 'checked' : '';?>>
                            ...
                            <fieldset class="form-check">
                            <input class="form-check-input" type="checkbox" id="Adoption" name="leave_type[]" value="Adoption Leave" <?php echo$leave_type =='Adoption Leave' ? 'checked' : '';?>>
                            <label class="form-check-label" for="Adoption"><b>Adoption Leave</b> <small>(R.A. No. 8552))</small></label>
                            </fieldset>
                            <div class="input-group">
                                  <fieldset class="form-check">
                            <input class="form-check-input" type="checkbox" id="Others" name="leave_type[]" value="Others" <?php echo$leave_type =='Others' ? 'checked' : '';?>>
                            <label class="form-check-label" for="Others">Others:</label>
                            </fieldset>
                                <input type="text" class="form-control border-top-0 border-right-0 border-left-0 " id="form1" name="leave_spent1[]"  class="form-control" <?php echo$leave_type =='Special Emergency (Camality) Leave' ? 'checked' : '';?>>     
                             </div>
                            ...
                            <div class="row">
                                ...
                                <input type="number" class="form-control border-top-0" id="validationDefault03" name="leave_days" value="<?php echo$leave_days;?>" required>
                                </div>
                                <hr style="height:2px;border-width:0;color:gray;background-color:gray">
                                <div class="col-md-6 ">
                                <label for="validationDefault03" class="form-label">DATE FROM:</label>
                                <input type="date" class="form-control border-0 " id="validationDefault03" name="leave_from" value="<?php echo$leave_from;?>" required>
                                </div>
                                <div class="col-md-6 ">
                                <label for="validationDefault03" class="form-label">DATE TO:</label>
                                <input type="date" class="form-control border-0 " id="validationDefault03" name="leave_to" value="<?php echo$leave_to;?>" required>
                                </div>
                            </div>
                    </div>
                            <div class="col-md-6">
                    ...
                    <hr style="height:2px;border-width:0;color:gray;background-color:gray">
                            <div class="col-12">
                                <a class="btn btn-danger" href="#" data-toggle="modal" data-target="#cancelModal"></i> Cancel Request</a>
                                <button class="btn btn-primary" type="submit"name="UpdateRequest" ><i class='fas fa-sign-in-alt'></i> Update Request</button>
                            </div>
                    </div>
 ...
 <div class="modal fade" id="cancelModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">Are You sure to cancel your Leave Request?.
                <input type="hidden"  class="form-control" id="validationCustom01" name="leave_id" value="<?php echo$leave_id;?>" ></div>
                <div class="modal-footer">
                    <button class="btn btn-info" type="button" data-dismiss="modal">Cancel</button>
                    <button class="btn btn-danger" type="submit"name="Delete" ><i class='fas fa-sign-in-alt'></i> Delete Request</button>
                </div>
            </div>
        </div>
    </div>
