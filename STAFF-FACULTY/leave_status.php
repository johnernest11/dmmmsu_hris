        ...
        <div class="table-responsive">
            <table class="table table-striped  leaveSta " id="dataTable" width="100%" cellspacing="0">
                ...
                <?php
                    ...
                    $conn = dbConnect();
                    $account = $conn->prepare("SELECT * FROM emp_leave 
                    WHERE  leave_recommendation ='Pending' 
                    ...
                    while($result = $account->fetch(PDO::FETCH_ASSOC)){
                      echo '<tr>    
                                    ...
                                    <td> 
                                    <a href="leave_profile.php?edit='.$result["leave_Id"].'"class="btn btn-success btn-sm "><span class ="fa fa-eye"> View</a>
                                    </td>
                            </tr>';
                    }
                    ob_end_flush();
        ...
        <div class="table-responsive">
           <table class="table table-striped  leaveSta1 " id="dataTable" width="100%" cellspacing="0">
                ...
                <?php
                    ...
                    AND l.leave_to >= DATE(NOW()) AND account.Id=$_SESSION[Id]");
                    $account->execute();
                    while($result = $account->fetch(PDO::FETCH_ASSOC)){
                      echo '<tr>
                                    <td>'.$result["leave_filling"].'</td>
