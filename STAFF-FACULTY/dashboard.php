         ...
         <!-- Card -->
            <div class="card profile-card">
              ...
              <div class="card-body pt-0 mt-0">
                ...
                <a class="btn btn-dark-green btn-block btn-sm" href="fpdf/PDS.php?edit=<?php echo $_SESSION['Id'];?>" target="_blank"> 
    ...
    <form method="POST" class="needs-validation" action=""  novalidate >
            ...
            <div class="form-row">
                <div class="col-md-2 mb-3">
                    ...
                    <input type="text" class="form-control" id="validationCustom05"  name="employee_height" value="<?php  echo$employee_height;?>" required>
                </div>
                <div class="col-md-2 mb-3">
                    <label for="validationCustom04">Weight(kg)</label>
                    <input type="text" class="form-control" id="validationCustom05"  name="employee_weight" value="<?php  echo$employee_weight;?>" required>
                </div>
                <div class="col-md-2 mb-3">
                ...
                <div class="col-md-3 mb-3">
                    ...
                    <input type="text" class="form-control" id="validationCustom05"  name="employee_telephone" value="<?php  echo$employee_telephone;?>">
                </div>
                <div class="col-md-3 mb-3">
                    <label for="validationCustom03">Contact No.</label>
                    <input type="text" class="form-control" id="validationCustom03"  name="employee_contact" value="<?php  echo$employee_contact;?>">
                </div>
            </div>
            <hr>
            ...
            <div class="form-row">
                ...
                <div class="col-md-3 mb-3">
                    ...
                    <input type="text" class="form-control" id="validationCustom05"  name=" employee_Rzipcode" value="<?php echo$employee_Rzipcode;?>">
                </div>
            </div>
            <hr>
            ...
            <div class="form-row">
                ...
                <div class="col-md-3 mb-3">
                    <label for="validationCustom05">Zipcode</label>
                    <input type="text" class="form-control" id="validationCustom05"  name="employee_Pzipcode" value="<?php echo$employee_Pzipcode;?>">
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" class="form-control" id="validationCustom04"  name="employee_gsis" value="<?php echo$employee_gsis;?>">
                </div>
                <div class="col-md-4 mb-3">
                    <label for="validationCustom05">PAG-IBIG NO.</label>
                    <input type="text" class="form-control" id="validationCustom05"  name="employee_pagibig" value="<?php echo$employee_pagibig;?>">
                </div>
                <div class="col-md-4 mb-3">
                    <label for="validationCustom03">PHILHEALTH</label>
                    <input type="text" class="form-control" id="validationCustom05"  name="employee_philhealth" value="<?php echo$employee_philhealth;?>">
                </div>
            </div>
            <div class="form-row">
                <div class="col-md-4 mb-3">
                    <label for="validationCustom04">SSS</label>
                    <input type="text" class="form-control" id="validationCustom05"  name="employee_sss" value="<?php echo$employee_sss;?>">
                </div>
                <div class="col-md-4 mb-3">
                    <label for="validationCustom05">TIN</label>
                    <input type="text" class="form-control" id="validationCustom05"  name="employee_tin" value="<?php echo$employee_tin;?>">
                </div>
            </div>
            <div class="form-row">
                <div class="col-md-4 mb-3">
                    <label for="validationCustom04">Agency Employee No</label>
                    <input type="text" class="form-control" id="validationCustom05"  name="employee_agency" value="<?php echo$employee_agency;?>">
                </div>
                <div class="col-md-4 mb-3">
                    <label for="validationCustom05">E-mail Address</label>
                    <input type="text" class="form-control" id="validationCustom05"  name="employee_email" value="<?php echo$employee_email;?>" >
                </div>
            </div>
            <!-- UPDATE BUTTON MODAL -->
        ...
        <form method="POST" class="needs-validation"  novalidate >
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="text" class="form-control" id="Sextext"  name="spouse_no" value="<?php echo$spouse_no;?>" required>
                    </div>
                </div>
                <hr>
                <div class="form-row">
    ...
    <form method="POST" class="needs-validation"  novalidate >
            <div class="form-row">
                ...
                <div class="col-md-6 mb-2">
                    ...
                    <input type="text" class="form-control" id="validationCustom02"  name="child_birthdate" value="<?php echo$child_birthdate;?>" > 
                </div>
                <div class="col-md-6 mb-2">
                    <input type="text" class="form-control" id="validationCustom02"  name="child_name1" value="<?php echo$child_name1;?>" >
                </div>
                <div class="col-md-6 mb-2">
                    <input type="text" class="form-control" id="validationCustom02"  name="child_birthdate1" value="<?php echo$child_birthdate1;?>" >
                </div>
            </div>
            <div class="form-row">
                <div class="col-md-6 mb-3">
                ...
                <div class="col-md-6 mb-3">
                    <input type="text" class="form-control" id="validationCustom04" name="child_birthdate2" value="<?php echo$child_birthdate2;?>">
                </div>
                <div class="col-md-6 mb-3">
                    <input type="text" class="form-control" id="Sextext"  name="child_name3" value="<?php echo$child_name3;?>" required>
                </div>
                <div class="col-md-6 mb-3">
                    <input type="text" class="form-control" id="Sextext"  name="child_birthdate3" value="<?php echo$child_birthdate3;?>" required>
                </div>
            </div>
            <div class="form-row">
                <div class="col-md-6 mb-3">
                ...
                <div class="col-md-6 mb-3">
                    <input type="text" class="form-control" id="Bloodtypetext"  name="child_birthdate4" value="<?php echo$child_birthdate4;?>" required>
                </div>
                <div class="col-md-6 mb-3">
                    <input type="text" class="form-control" id="validationCustom05"  name="child_name5" value="<?php echo$child_name5;?>" required>
                </div>
                <div class="col-md-6 mb-3">
                    <input type="text" class="form-control" id="validationCustom05"  name="child_birthdate5" value="<?php echo$child_birthdate5;?>" required>
                </div>
                <div class="col-md-6 mb-3">
                    <input type="text" class="form-control" id="validationCustom05"  name="child_name6" value="<?php echo$child_name6;?>" required>
                </div>
                <div class="col-md-6 mb-3">
                    <input type="text" class="form-control" id="validationCustom05"  name="child_birthdate6" value="<?php echo$child_birthdate6;?>" required>
                </div>
            </div>
            <div class="form-row">
                <div class="col-md-6 mb-3">
                ...
                <div class="col-md-6 mb-3">
                    <input type="text" class="form-control" id="validationCustom05"  name="child_birthdate7" value="<?php echo$child_birthdate7;?>">
                </div>
                <div class="col-md-6 mb-3">
                    <input type="text" class="form-control" id="validationCustom03"  name="child_name8" value="<?php echo$child_name8;?>">
                </div>
                <div class="col-md-6 mb-3">
                    <input type="text" class="form-control" id="validationCustom03"  name="child_birthdate8" value="<?php echo$child_birthdate8;?>">
                </div>
                <div class="col-md-6 mb-3">
                    <input type="text" class="form-control" id="validationCustom05"  name="child_name9" value="<?php echo$child_name9;?>">
                </div>
                <div class="col-md-6 mb-3">
                    <input type="text" class="form-control" id="validationCustom05"  name="child_birthdate9" value="<?php echo$child_birthdate9;?>">
                </div>
                <div class="col-md-6 mb-3">
                    <input type="text" class="form-control" id="validationCustom03"  name="child_name10" value="<?php echo$child_name10;?>">
                </div>
                <div class="col-md-6 mb-3">
                    <input type="text" class="form-control" id="validationCustom03"  name="child_birthdate10" value="<?php echo$child_birthdate10;?>">
                </div>
                <div class="col-md-6 mb-3">
                    <input type="text" class="form-control" id="validationCustom05"  name="child_name11" value="<?php echo$child_name11;?>">
                </div>
                <div class="col-md-6 mb-3">
                    <input type="text" class="form-control" id="validationCustom05"  name="child_birthdate11" value="<?php echo$child_birthdate11;?>">
                </div>
            </div>
            <hr>    
...
<!--EDUCATION NAVIGATION TAB-->
            ...
            <label for="validationCustom01"><strong>ELEMENTARY</strong></label>
                <div class="form-row">
                    ...
                    <div class="col-md-2 mb-2">
                        ...
                        <input type="text" class="form-control" id="validationCustom02"  name="elem_from" value="<?php echo$elem_from;?>" >
                    </div>
                    <div class="col-md-2 mb-2">
                        <label for="validationCustom02">TO</label>
                        <input type="text" class="form-control" id="validationCustom02"  name="elem_to" value="<?php echo$elem_to;?>" >
                    </div>
                </div>
                <div class="form-row">
                    <div class="col-md-4 mb-3">
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-2 mb-2">
                        <label for="validationCustom02">FROM</label>
                        <input type="text" class="form-control" id="validationCustom02"  name="sec_from" value="<?php echo$sec_from;?>" >
                    </div>
                    <div class="col-md-2 mb-2">
                        <label for="validationCustom02">TO</label>
                        <input type="text" class="form-control" id="validationCustom02"  name="sec_to" value="<?php echo$sec_to;?>" >
                    </div>
                </div>
                <div class="form-row">
                    <div class="col-md-4 mb-3">
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-2 mb-2">
                        <label for="validationCustom02">FROM</label>
                        <input type="text" class="form-control" id="validationCustom02"  name="voc_from" value="<?php echo$voc_from;?>" >
                    </div>
                    <div class="col-md-2 mb-2">
                        <label for="validationCustom02">TO</label>
                        <input type="text" class="form-control" id="validationCustom02"  name="voc_to" value="<?php echo$voc_to;?>" >
                    </div>
                </div>
                <div class="form-row">
                    <div class="col-md-4 mb-3">
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-2 mb-2">
                        <label for="validationCustom02">FROM</label>
                        <input type="text" class="form-control" id="validationCustom02"  name="col_from" value="<?php echo$col_from;?>" >
                    </div>
                    <div class="col-md-2 mb-2">
                        <label for="validationCustom02">TO</label>
                        <input type="text" class="form-control" id="validationCustom02"  name="col_to" value="<?php echo$col_to;?>" >
                    </div>
                </div>
                <div class="form-row">
                    <div class="col-md-4 mb-3">
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-2 mb-2">
                        <label for="validationCustom02">FROM</label>
                        <input type="text" class="form-control" id="validationCustom02"  name="gad_from" value="<?php echo$gad_from;?>" >
                    </div>
                    <div class="col-md-2 mb-2">
                        <label for="validationCustom02">TO</label>
                        <input type="text" class="form-control" id="validationCustom02"  name="gad_to" value="<?php echo$gad_to;?>" >
                    </div>
                </div>
                <div class="form-row">
                    <div class="col-md-4 mb-3">
                ...
                <div class="form-row">
                    <div class="col-md-4 mb-3">
                        <label for="validationCustom01">NAME OF SCHOOL</label>
                        <input type="text" class="form-control" id="gad_name1"  name="gad_name1" value="<?php echo$gad_name1;?>">
                    </div>
                    <div class="col-md-4 mb-2">
                        <label for="validationCustom02">BASIC DEGREE/COURSE</label>
                        <input type="text" class="form-control" id="gad_degree1"  name="gad_degree1" value="<?php echo$gad_degree1;?>" > 
                    </div>
                    <div class="col-md-2 mb-2">
                        <label for="validationCustom02">FROM</label>
                        <input type="text" class="form-control" id="gad_from1"  name="gad_from1" value="<?php echo$gad_from1;?>" >
                    </div>
                    <div class="col-md-2 mb-2">
                        <label for="validationCustom02">TO</label>
                        <input type="text" class="form-control" id="gad_to1"  name="gad_to1" value="<?php echo$gad_to1;?>" >
                    </div>
                </div>
                <div class="form-row">
                    <div class="col-md-4 mb-3">
                        <label for="validationCustom03">HIGHEST LEVEL/UNIT EARNED</label>
                        <input type="text" class="form-control" id="gad_earned1"  name="gad_earned1" value="<?php echo$gad_earned1;?>" required>
                    </div>
                    <div class="col-md-3 mb-3">
                        <label for="validationCustom04">YEAR GRADUATED</label>
                        <input type="text" class="form-control" id="validationCustom04"  value="<?php echo$gad_to1;?>" disabled>
                    </div>
                    <div class="col-md-5 mb-3">
                        <label for="validationCustom05">SCHOLARSHIP /ACADEMIC RECIEVED</label>
                        <input type="text" class="form-control" id="gad_honor1"  name="gad_honor1" value="<?php echo$gad_honor1;?>" required>
                    </div>
                </div>
                <hr>    
    ...
    <div class="tab-pane fade" id="nav-voluntary" role="tabpanel" aria-labelledby="nav-voluntary-tab">
            <br>
            <label for="validationCustom01"><strong>VOLUNTARY WORK OR INVOLVEMENT IN CIVIC /NON-GOVERMENT/PEOPLE/VOLUNTARY ORGANIZATION/S</strong></label>
            <hr>
            <div class="card-body">
                <div class="table-responsive">
            ...
            <form method="POST" class="needs-validation"  novalidate >
                            <div class="form-row">
                                ...
                                <div class="col-md-2 mb-2">
                                    ...
                                    <input type="text" class="form-control" id="validationCustom02"  name="reference_tel" value="<?php echo$reference_tel;?>" >
                                </div>
                                <div class="col-md-5 mb-3">
                                ...
                                <div class="col-md-2 mb-2">
                                    <input type="text" class="form-control" id="validationCustom02"  name="reference_tel1" value="<?php echo$reference_tel1;?>">
                                </div>
                                <div class="col-md-5 mb-3">
                                ...
                                <div class="col-md-2 mb-2">
                                    <input type="text" class="form-control" id="validationCustom02"  name="reference_tel2" value="<?php echo$reference_tel2;?>">
                                </div>
                            </div>
                            <hr>    
                            <!-- MODAL REFERENCE -->
            ...
            <form method="POST" class="needs-validation"  novalidate >
                            <div class="form-row">
                                ...
                                <div class="col-md-2 mb-2">
                                    ...
                                    <input type="text" class="form-control" id="validationCustom02"  name="government_date" value="<?php echo$government_date;?>" placeholder="MM-DD-YYYY" >
                                </div>
                                <div class="col-md-3 mb-2">
 ...
 <!-- Dashboard js plugins -->
    ...
    <script src="js/dashboard/eligibility.js"></script>
    <script src="js/dashboard/program.js"></script>
    <script src="js/dashboard/reference.js"></script>
    <script src="js/dashboard/work.js"></script>
    <script src="js/dashboard/voluntary.js"></script>
