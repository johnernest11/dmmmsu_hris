            ...
            <div class="modal-body">
                ...
                <div class="form-row">
                                    ...
                                    <div class="col-md-2 mb-2">
                                        ...
                                        <input type="text" class="form-control" id="voluntary_fromv"  name="voluntary_fromv">
                                    </div>
                                    <div class="col-md-2 mb-3">
                                        <label for="validationCustom01">To (mm/dd/yyy)</label>
                                        <input type="text" class="form-control" id="voluntary_tov"  name="voluntary_tov" >
                                    </div>
                                    <div class="col-md-2 mb-2">
                                        <label for="validationCustom02">No. of Hours</label>
                                        <input type="text" class="form-control" id="voluntary_hoursv"  name="voluntary_hoursv"  >
                                    </div>
                                    <div class="col-md-2 mb-2">
                                        <label for="validationCustom02">Position</label>
